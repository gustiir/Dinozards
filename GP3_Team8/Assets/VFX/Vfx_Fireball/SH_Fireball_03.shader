...
Shader "SH_SwordSlash_02"
{
	Properties
	{
		...
		_Upline_G_Intensity("Upline_G_Intensity", Float) = 1
		_Trail_Tex_Intensity("Trail_Tex_Intensity", Float) = 1
		_TextureSample2("Texture Sample 2", 2D) = "white" {}
		_Alpha_Intensity("Alpha_Intensity", Float) = 1
		_Noise_Use("Noise_Use", Float) = 1
		_Noise_Use_off("Noise_Use_off", Float) = 1
		_Upline_Trail_No("Upline_Trail_No", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult108 = lerp( ( temp_output_77_0 + temp_output_44_0 ) , temp_output_77_0 , _Noise_Use);
			float4 temp_output_85_0 = ( ( tex2D( _TextureSample1, lerpResult108.xy ).r * _UpLine_Trail_Color ) * _Upline_G_Intensity );
			float4 temp_cast_8 = (_Upline_Trail_No).xxxx;
			float4 lerpResult109 = lerp( temp_output_85_0 , temp_cast_8 , 0.0);
			...
			float4 lerpResult110 = lerp( ( temp_output_44_0 + temp_output_63_0 ) , temp_output_63_0 , _Noise_Use_off);
			float4 tex2DNode67 = tex2D( _TextureSample0, lerpResult110.xy );
			o.Emission = ( ( temp_output_85_0 * ( lerpResult109 + ( ( ( color93 * tex2DNode67.r ) * _Trail_Tex_Intensity ) * i.vertexColor ) ) ) * i.vertexColor ).rgb;
			o.Alpha = 1;
			float2 uv_TextureSample2 = i.uv_texcoord * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
			clip( ( i.vertexColor.a * ( i.vertexColor.a * ( ( ( lerpResult109 + tex2DNode67.r ) * tex2D( _TextureSample2, uv_TextureSample2 ).r ) * _Alpha_Intensity ) ) ).r - _Cutoff );
		}
...
/*ASEBEGIN
Version=16400
-1911;-1;1918;1016;2067.816;807.8509;1.639054;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;81;-3541.046,-814.3665;Float;False;1720.5;642.0871;Comment;13;69;70;76;72;73;75;74;71;78;77;80;108;112;Small flashy line "Upline";1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-3457.168,-546.0328;Float;False;Property;_UpLine_V_Scale;UpLine_V_Scale;13;0;Create;True;0;0;False;0;1;-0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-3491.046,-709.9418;Float;False;Property;_UpLine_U_Scale;UpLine_U_Scale;12;0;Create;True;0;0;False;0;1;0.56;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;68;-3367.558,817.8611;Float;False;1674.521;781.4363;Comment;13;53;62;52;63;64;67;60;55;54;57;58;110;111;Trail noise with crackling noise;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-3306.617,-441.8094;Float;False;Property;_UpLine_U_Move;UpLine_U_Move;14;0;Create;True;0;0;False;0;0;-0.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-3291.757,-304.6124;Float;False;Property;_UpLine_V_Move;UpLine_V_Move;11;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-3317.558,1215.197;Float;False;Property;_Trail_V_Scale;Trail_V_Scale;8;0;Create;True;0;0;False;0;1;0.83;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-3079.057,1280.298;Float;False;Property;_Trail_U_Move;Trail_U_Move;9;0;Create;True;0;0;False;0;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-3083.167,1392.382;Float;False;Property;_Trail_V_Move;Trail_V_Move;10;0;Create;True;0;0;False;0;0;0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-2412.403,-314.9114;Float;False;Property;_Noise_Use;Noise_Use;24;0;Create;True;0;0;False;0;1;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;92;-1708.884,-560.5074;Float;False;1011.463;401.3291;Comment;8;83;84;85;86;87;88;113;109;Intensity "Emissive" slider for Upline;1,1,1,1;0;0
Node;AmplifyShaderEditor.LerpOp;108;-2322.56,-528.9817;Float;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;83;-1658.884,-390.1456;Float;False;Property;_UpLine_Trail_Color;UpLine_Trail_Color;17;0;Create;True;0;0;False;0;1,1,1,1;1,0.4745098,0.2039216,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;80;-2146.546,-542.241;Float;True;Property;_TextureSample1;Texture Sample 1;16;0;Create;True;0;0;False;0;db1dfc3f73c87b645a0a231d3df3248b;db1dfc3f73c87b645a0a231d3df3248b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;111;-2509.788,1289.481;Float;False;Property;_Noise_Use_off;Noise_Use_off;25;0;Create;True;0;0;False;0;1;1.26;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;-1414.915,-509.7075;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;110;-2259.089,1117.342;Float;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1452.522,-277.9787;Float;False;Property;_Upline_G_Intensity;Upline_G_Intensity;18;0;Create;True;0;0;False;0;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;85;-1255.813,-547.5076;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-1217.971,-330.084;Float;False;Property;_Upline_Trail_No;Upline_Trail_No;26;0;Create;True;0;0;False;0;0;0.47;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-1194.421,-230.1786;Float;False;Constant;_Upline_Trail_use;Upline_Trail_use;21;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;67;-2026.035,1049.261;Float;True;Property;_TextureSample0;Texture Sample 0;15;0;Create;True;0;0;False;0;6f17e8468f1c83e47bca5fe95d151018;6f17e8468f1c83e47bca5fe95d151018;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1592.58,340.185;Float;False;Property;_Trail_Tex_Intensity;Trail_Tex_Intensity;21;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;109;-919.0851,-313.2854;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;98;-1340.734,1101.411;Float;True;Property;_TextureSample2;Texture Sample 2;22;0;Create;True;0;0;False;0;bca9821de3818b2438d8118658fced30;bca9821de3818b2438d8118658fced30;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;100;-911.6661,920.1853;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-910.1042,1215.464;Float;False;Property;_Alpha_Intensity;Alpha_Intensity;23;0;Create;True;0;0;False;0;1;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;-835.9554,123.9657;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;89;-638.4616,-212.6264;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.VertexColorNode;140;-384.792,288.2903;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;88;-1000.421,-452.1785;Float;False;Property;_UpLine_Trail_Use;UpLine_Trail_Use;19;0;Create;True;0;0;False;0;0;1;0;True;;ToggleOff;2;Key0;Key1;Create;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;91;-838.2494,605.0472;Float;False;Property;_ParticleColor;Particle Color;20;0;Create;True;0;0;False;0;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;139;-182.6232,629.6045;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;-156.6791,-147.3121;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;46;0,0;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;SH_SwordSlash_02;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.16;True;False;0;True;TransparentCutout;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;0;False;-1;0;False;-1;0;1;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;103;0;114;4
WireConnection;103;1;101;0
WireConnection;88;1;87;0
WireConnection;88;0;85;0
WireConnection;139;0;140;4
WireConnection;139;1;103;0
WireConnection;141;0;107;0
WireConnection;141;1;140;0
WireConnection;46;2;141;0
WireConnection;46;10;139;0
ASEEND*/
//CHKSM=51C5DCF72F306394DA2A0AF6D23FA0A4B7553456