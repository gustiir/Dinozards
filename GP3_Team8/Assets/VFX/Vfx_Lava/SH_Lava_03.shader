...
Shader "SH_Lava_02"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = tex2D( _Rock_Normal, panner11 ).rgb;
			float2 uv_TexCoord2 = i.uv_texcoord * float2( 5,5 );
			float4 appendResult24 = (float4(_ScaleXLava , _ScaleYLava , 0.0 , 0.0));
			float2 panner12 = ( 1.0 * _Time.y * float2( -0.25,0 ) + ( float4( uv_TexCoord2, 0.0 , 0.0 ) * appendResult24 ).xy);
			...
			float lerpResult19 = lerp( 1.8 , 0.1 , tex2D( _Fire_02, panner13 ).r);
			o.Emission = ( ( tex2D( _Fire_01, panner12 ) * _Brightness ) * ( 0.0 + lerpResult19 ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16400
-1878;41;1918;1016;2200.877;485.0218;1.415;True;False
...
Node;AmplifyShaderEditor.PannerNode;12;-1692.669,232.7507;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.25,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1066.737,385.2742;Float;False;Property;_Brightness;Brightness;3;0;Create;True;0;0;False;0;10;4;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E7408C2FD28ADFDBC169E74644B0183FB6F4D33F